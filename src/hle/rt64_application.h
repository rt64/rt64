...
#   endif
        ...
        void updateScreen();
        CPPDLLEXPORT void updateMultisampling();
        void end();
...
#   endif
        CPPDLLEXPORT void updateUserConfig(bool discardFBs);
        CPPDLLEXPORT void updateEnhancementConfig();
        CPPDLLEXPORT void setFullScreen(bool fullscreen);
    };
};